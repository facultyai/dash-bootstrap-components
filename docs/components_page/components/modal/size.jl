...
modal = html_div([
    dbc_button("Small modal", id="open-sm", class_name="mr-1", n_clicks=0),
    dbc_button("Large modal", id="open-lg", class_name="mr-1", n_clicks=0),
    ...
    dbc_modal(
        [
            ...
            dbc_modalfooter(
                dbc_button("Close", id="close-sm", class_name="ml-auto", n_clicks=0),
            ),
        ],
        id="modal-sm",
        size="sm",
    ...
    dbc_modal(
        [
            ...
            dbc_modalfooter(
                dbc_button("Close", id="close-lg", class_name="ml-auto", n_clicks=0),
            ),
        ],
        id="modal-lg",
        size="lg",
    ...
    dbc_modal(
        [
            ...
            dbc_modalfooter(
                dbc_button("Close", id="close-xl", class_name="ml-auto", n_clicks=0),
            ),
        ],
        id="modal-xl",
        size="xl",
