...
function dbc_checklist(; kwargs...)
        available_props = Symbol[:id, :options, :value, :className, :style, :key, :inputStyle, :inputClassName, :labelStyle, :labelCheckedStyle, :labelClassName, :labelCheckedClassName, :inline, :switch, :custom, :loading_state, :persistence, :persisted_props, :persistence_type]
        wild_props = Symbol[]
