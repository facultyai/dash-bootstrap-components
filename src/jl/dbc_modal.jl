...
function dbc_modal(; kwargs...)
        available_props = Symbol[:children, :id, :autoFocus, :autofocus, :backdrop, :backdropClassName, :backdrop_class_name, :centered, :className, :class_name, :contentClassName, :content_class_name, :fade, :fullscreen, :is_open, :keyboard, :labelledBy, :labelledby, :modalClassName, :modal_class_name, :role, :scrollable, :size, :style, :tag, :zIndex, :zindex]
        wild_props = Symbol[]
