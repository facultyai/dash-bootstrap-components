...
"""
function dbc_cardimgoverlay(; kwargs...)
        available_props = Symbol[:children, :id, :style, :className, :key, :tag, :loading_state]
        wild_props = Symbol[]
        return Component("dbc_cardimgoverlay", "CardImgOverlay", "dash_bootstrap_components", available_props, wild_props; kwargs...)
end

dbc_cardimgoverlay(children::Any; kwargs...) = dbc_cardimgoverlay(;kwargs..., children = children)
dbc_cardimgoverlay(children_maker::Function; kwargs...) = dbc_cardimgoverlay(children_maker(); kwargs...)
