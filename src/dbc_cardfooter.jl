...
"""
function dbc_cardfooter(; kwargs...)
        available_props = Symbol[:children, :id, :style, :className, :key, :tag, :loading_state]
        wild_props = Symbol[]
        return Component("dbc_cardfooter", "CardFooter", "dash_bootstrap_components", available_props, wild_props; kwargs...)
end

dbc_cardfooter(children::Any; kwargs...) = dbc_cardfooter(;kwargs..., children = children)
dbc_cardfooter(children_maker::Function; kwargs...) = dbc_cardfooter(children_maker(); kwargs...)
