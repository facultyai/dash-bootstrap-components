...
dbcRadioItems <- function(id=NULL, key=NULL, options=NULL, value=NULL, style=NULL, className=NULL, inputStyle=NULL, inputClassName=NULL, labelStyle=NULL, labelCheckedStyle=NULL, labelClassName=NULL, labelCheckedClassName=NULL, inline=NULL, switch=NULL, custom=NULL, loading_state=NULL, persistence=NULL, persisted_props=NULL, persistence_type=NULL, name=NULL) {
    ...
    component <- list(
        ...
        propNames = c('id', 'key', 'options', 'value', 'style', 'className', 'inputStyle', 'inputClassName', 'labelStyle', 'labelCheckedStyle', 'labelClassName', 'labelCheckedClassName', 'inline', 'switch', 'custom', 'loading_state', 'persistence', 'persisted_props', 'persistence_type', 'name'),
