...
dbcChecklist <- function(id=NULL, options=NULL, value=NULL, className=NULL, style=NULL, key=NULL, inputStyle=NULL, inputClassName=NULL, labelStyle=NULL, labelCheckedStyle=NULL, labelClassName=NULL, labelCheckedClassName=NULL, inline=NULL, switch=NULL, custom=NULL, loading_state=NULL, persistence=NULL, persisted_props=NULL, persistence_type=NULL) {
    ...
    component <- list(
        ...
        propNames = c('id', 'options', 'value', 'className', 'style', 'key', 'inputStyle', 'inputClassName', 'labelStyle', 'labelCheckedStyle', 'labelClassName', 'labelCheckedClassName', 'inline', 'switch', 'custom', 'loading_state', 'persistence', 'persisted_props', 'persistence_type'),
